...
const cardOne = document.querySelector('.faq-info-wrapper-one');
const myImgOne = document.querySelector('.myImgOne');
    

//open-close 1
btnOne.addEventListener('click', ()=>{
    cardOne.classList.toggle('content-hidden');
    if(cardOne.classList.contains('content-hidden')){
...
const cardTwo = document.querySelector('.faq-info-wrapper-two');
const myImgTwo = document.querySelector('.myImgTwo');
    

//open-close 2
btnTwo.addEventListener('click', ()=>{
    cardTwo.classList.toggle('content-hidden');
    if(cardTwo.classList.contains('content-hidden')){
